...
const publicApiPrefixes = ["/api/auth/login", "/api/auth/logout", "/api/auth/google", "/api/auth/callback/google", "/api/internal/export-jobs/process", "/api/cron/generated-file-cleanup"];
