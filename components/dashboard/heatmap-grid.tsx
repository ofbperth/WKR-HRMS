...
function Legend() {
  return <div className="flex flex-wrap items-center gap-2 text-xs text-slate-600"><span>Low</span><span className="h-4 w-8 rounded bg-emerald-100" /><span>Medium</span><span className="h-4 w-8 rounded bg-yellow-300" /><span>High</span><span className="h-4 w-8 rounded bg-orange-400" /><span>Critical</span><span className="h-4 w-8 rounded bg-red-600" /></div>;
}
