...
export default async function ExecutiveSafetyGoalsPage({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  return <AppShell user={user}><div className="space-y-6">
    <div><h1 className="text-2xl font-bold">9 เป้าหมายความปลอดภัยสำคัญ</h1><p className="text-sm text-slate-600">สรุปแนวโน้ม RCA แผนแก้ไข และ incident ที่เกี่ยวข้องในแต่ละเป้าหมาย</p></div>
