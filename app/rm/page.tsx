...
export default async function Page() {
  ...
  return <AppShell user={user}><RoleHome title="RM Team Workbench" description="Triage incident, ค้นหา, ติดตาม RCA และบริหาร Risk Log">
    ...
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Link href="/rm/incidents" className={actionClass}><div className="font-semibold text-slate-900">Incident Log</div><p className="mt-1 text-sm text-slate-600">Risk log ทั้งองค์กร</p></Link>
    </div>
  </RoleHome></AppShell>;
}
